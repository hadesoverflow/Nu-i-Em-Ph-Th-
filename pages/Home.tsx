...
const Home: React.FC = () => {
  ...
  return (
    <div className="overflow-x-hidden">
      {/* Hero Section */}
      <section className="relative bg-cover bg-center h-[70vh] md:h-[90vh] animate-fadeIn" style={{ backgroundImage: "url('https://images.pexels.com/photos/8947691/pexels-photo-8947691.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&dpr=2')" }}>
          ...
          <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <Link to="/tulieu" className="group bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                      <img src="https://images.pexels.com/photos/8947682/pexels-photo-8947682.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=2" alt="Hoạt động 1" className="w-full h-56 object-cover transition-transform duration-300 group-hover:scale-105"/>
                      <div className="p-6">
                  ...
                  <Link to="/tulieu" className="group bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                      <img src="https://images.pexels.com/photos/8947671/pexels-photo-8947671.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=2" alt="Hoạt động 2" className="w-full h-56 object-cover transition-transform duration-300 group-hover:scale-105"/>
                       <div className="p-6">
                   ...
                   <Link to="/taichinh" className="group bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                      <img src="https://images.pexels.com/photos/8947677/pexels-photo-8947677.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=2" alt="Hoạt động 3" className="w-full h-56 object-cover transition-transform duration-300 group-hover:scale-105"/>
                       <div className="p-6">
                          <span className="text-sm text-emerald-600 font-semibold">Tài chính</span>
                          <h3 className="font-bold text-xl mt-2 mb-2 text-gray-800">Báo cáo tài chính tháng 7</h3>
